...
storiesOf("Button", module)
  ...
  .add("Edit", () => <Form  student={"Lydia"} interviewer={4} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")}/>)
  ...
  .add("Appointment Booked", () => (
    <Fragment>
      <Appointment
        id={4}
        time="4pm"
        interview={{student : "Lydia Mi-Jones", interviewer} }
      />
      <Appointment time="5pm" />
    </Fragment>
  ));
